...
int main() {
    ...
    initialize_job_queue(); // Inicializa cola y semáforo

    enqueue_job();  // Agrega trabajo 1
    enqueue_job();  // Agrega trabajo 2
    enqueue_job();  // Agrega trabajo 3
    enqueue_job();  // Agrega trabajo 4
